...
public class escalar extends JFrame {
	...
	public escalar() {
		...
		JLabel lblIngreseLosNumeros = new JLabel("Ingrese los numeros a operar");
		...
		lblAcVaEl.setBounds(147, 364, 50, 55);
		...
		btnNewButton_1_4_1_1_1.setBounds(202, 455, 140, 45);
		...
		lblAcVaEl_1.setBounds(190, 364, 334, 55);
		...
		btnNewButton_1_4_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
		        ...
		        if(numeros1.length != numeros2.length) {
		        	...
		        	lblAcVaEl_1.setText("ERROR: Las longitudes son diferentes )");
