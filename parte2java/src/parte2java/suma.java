...
public class suma extends JFrame {
	...
	public suma() {
		...
		lblV_1.setHorizontalAlignment(SwingConstants.LEFT);
		lblV_1.setForeground(Color.WHITE);
		lblV_1.setFont(new Font("Arial", Font.BOLD, 20));
		lblV_1.setAlignmentX(0.5f);
		lblV_1.setBounds(11, 204, 67, 39);
		...
		JLabel lblPrimerVector_1_1 = new JLabel("Segundo vector: ");
		...
		lblPrimerVector_1_1.setBounds(11, 171, 151, 30);
		...
		btnNewButton_1_4_1_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		btnNewButton_1_4_1_1_1.setBounds(207, 325, 140, 45);
